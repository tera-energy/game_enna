...
public class TrPuzzleManager : MonoBehaviour
{
    ...
    protected virtual IEnumerator yProcReadyGame(){
        ...
        TrUI_PuzzleEnna.xInstance.zSetNotice(TrNoticeType.READY);
        yield return TT.WaitForSeconds(2f);
        TrUI_PuzzleEnna.xInstance.zSetNotice(TrNoticeType.GO);
        yield return TT.WaitForSeconds(1f);
        TrUI_PuzzleEnna.xInstance.zSetNotice(TrNoticeType.DISABLE);
